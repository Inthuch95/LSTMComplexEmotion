...
from emoreact.utils import load_vgg_sequence, exact_match_ratio, accuracy, precision, recall, f1_measure
...
if __name__ == '__main__':
    ...
    X_train, y_train, X_val, y_val, X_test, y_test = load_vgg_sequence(label_type='emotion')
