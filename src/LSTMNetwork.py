...
from eess.utils import get_predictions_and_labels, plot_confusion_matrix
...
class LSTMNetwork():
    def __init__(self, n_layer, lstm_unit, input_shape, labels, feature='VGG16', output_activation='softmax'):
        self.labels = labels
